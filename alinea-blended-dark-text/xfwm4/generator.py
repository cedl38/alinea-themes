...
def build():
    ...
    gtop = globals()
    for i in ("title_4", "title_5"):
        for j in ("active", "inactive"):
            name = "%s_%s" % (i,j)
            if name in gtop:
                generate(name.replace("_", "-"), gtop[name], gtop["%s_map" % name])
    #bottom
...
close_active_map = {
    ...
    "$" : "#b1b1b1 s active_shadow_2",
    "+" : "#505050 s active_text_color",
    "@" : "#505050 s active_text_color",
    "#" : "#505050 s active_text_color",
}
...
$$$$$$$$$$$$$$$$$$
'''.strip()
maximize_active_map = hide_active_map
...
maximize_inactive_map = hide_inactive_map
...
$$$$$$$$$$$$$$$$$$
'''.strip()
maximize_toggled_active_map = hide_active_map
...
maximize_toggled_inactive_map = hide_inactive_map
...
menu_prelight_map = menu_active_map
...
menu_inactive_map = hide_inactive_map
...
$$$$$$$$$$$$$$$$$$
'''.strip()
shade_active_map = hide_active_map
...
$$$$$$$$$$$$$$$$$$
'''.strip()
shade_toggled_active_map = hide_active_map
...
================
'''.strip()
stick_active_map = hide_active_map
...
================
'''.strip()
stick_toggled_active_map = hide_active_map
...
=======
'''.strip()
title_4_active_map = amap
title_4_inactive = title_4_active
title_4_inactive_map = imap
...
=======================
'''.strip()
title_5_active_map = amap
title_5_inactive = title_5_active
title_5_inactive_map = imap
